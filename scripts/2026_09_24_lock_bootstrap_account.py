"""
Deactivate the PCM001 bootstrap account.
...
This deactivates it.  It does not delete it — the account is referenced
by created_by fields and is the documented way back in if every admin
is locked out.
