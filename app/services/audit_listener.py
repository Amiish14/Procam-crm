...
WATCH = {
    'Lead': ('lead', {
        ...
        'opportunity_value_num': 'lead.value_change',
        'value_currency': 'lead.value_change',
        'value_basis': 'lead.value_change',
        'quote_no': 'lead.quote_change',
        'quote_value_num': 'lead.quote_change',
