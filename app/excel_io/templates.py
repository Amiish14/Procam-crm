...
_t('person', 'People Master',
   ...
   'Contact',
   [
     ('Full Name',    'name',        True,  None, 'Customer Contact', ''),
     ...
     ('Email',        'email',       False, None, 'contact@example.com',
...
_t('company_contact', 'Company + Contact combined',
   ...
   [
     ...
     ('Contact Name',  '_person_name', False, None, 'Customer Contact', ''),
     ('Designation',   '_designation', False, None, 'Procurement Head', ''),
     ('Contact Email', '_person_email', False, None, 'contact@example.com',
      ''),
...
_t('lead', 'Historical Lead',
   ...
   [
     ...
     ('Contact Person', 'pic',        False, None, 'Customer Contact', ''),
...
_t('overseas_agent', 'Overseas Agent / Partner',
   ...
   [
     ...
     ('Contact Name',     '_person_name', False, None, 'Agent Contact',
     ...
     ('Contact Email',    '_person_email', False, None,
      'agent.contact@example.com', 'Used to spot an existing person.'),
     ('Contact Mobile',   '_person_mobile', False, None, '', ''),
     ('Account Owner',    'pic_emp_code', False, None, 'EMP372011',
